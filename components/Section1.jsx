...
import { prgg, boy } from "../public/index";
const Section1 = () => {
  return (
    <div className="relative h-[800px]  2xl:h-screen top-0 shadow-2xl  shadow-teal-600">
      <Image src={prgg} fill alt="background" className="h-full object-cover" />
      <div className="absolute h-full bg-gray-900 bg-opacity-80 w-full ">
        <div className="flex justify-start items-start md:pt-6">
          <div className="xl:max-w-[1280px] mx-auto  w-full">
            <div className="flex md:flex-row flex-col sm:py-16 py-2 xl:max-w-[1280px] w-full">
              <div className="flex-1 flex justify-center items-start flex-col xl:px-0 sm:px-16 py-0 px-6">
                ...
                <p className="font-poppins  bg-prim-550  bg-opacity-50 text-white px-3  py-4 rounded-xl shadow-md font-medium shadow-second-500 text-[18px] leading-[30.8px] max-w-[470px] mt-5">
                  Elevate your tech journey with our curated resources and
                  roadmaps. Unleash industry-leading IT insights at your
                  fingertips. Achieve mastery in IT roles with our empowering
                  platform.
                  <span className="absolute z-[0]  w-10 h-10 white__gradient rounded-full bottom-27" />
                </p>
              </div>
              <div className="flex flex-1  justify-center items-center my-10 relative">
                <Image
                  src={boy}
                  alt="boy"
