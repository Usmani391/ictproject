...
const Hero = () =>{ 
return(
  <section id="home" className="flex justify-start items-start mt-5">
<div className="xl:max-w-[1280px] mx-auto  w-full">
  <div  className="flex md:flex-row-reverse flex-col justify-between sm:py-16 py-6 xl:max-w-[1280px] w-full">
